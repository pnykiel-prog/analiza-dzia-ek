...
export const DZIALKI_PRZYKLADOWE: DaneDzialki[] = [
  {
    ...
    udzialAktywniPct: 31,
    medianaAktywniWoj: 27,
    saldoMigracjiMlodzi: 8,
    udzial65PlusPct: 16,
    liczbaMieszkancowGminy: 30000,
    liczbaAktywni: 16000,
    liczba65Plus: 4800,
    dochodPrzecietnyGmina: 7800,
    naplywZameldowanNa1000: 28,
    odplywMlodychNa1000: 10,
    trend65Plus: "rosnacy",
...

  {
    ...
    udzialAktywniPct: 24,
    medianaAktywniWoj: 26,
    saldoMigracjiMlodzi: 1,
    udzial65PlusPct: 24,
    liczbaMieszkancowGminy: 27000,
    liczbaAktywni: 13500,
    liczba65Plus: 6480,
    dochodPrzecietnyGmina: 6400,
    naplywZameldowanNa1000: 18,
    odplywMlodychNa1000: 14,
    trend65Plus: "rosnacy",
    populacjaStabilna: true,
...

  {
    ...
    udzialAktywniPct: 21,
    medianaAktywniWoj: 25,
    saldoMigracjiMlodzi: -6,
    udzial65PlusPct: 26,
    liczbaMieszkancowGminy: 11000,
    liczbaAktywni: 6000,
    liczba65Plus: 2860,
    dochodPrzecietnyGmina: 5100,
    naplywZameldowanNa1000: 8,
    odplywMlodychNa1000: 22,
    trend65Plus: "rosnacy",

    ...
    <>
      ...
      <div
        ...
        dangerouslySetInnerHTML={{
          __html: `<grunt-map mode="${mode}" view="${view}" layers='${layersJson}' style="display:block;width:100%;height:${height}px"></grunt-map>`,
        }}
      />
    </>
  );
  ...
  return (
    <section className="card overflow-hidden">
      ...
      <div className="bg-grunt-map-bg">
        <GruntMap mode={mode} view={view} layers={layers} height={height} />
      </div>
    </section>
  );
}
